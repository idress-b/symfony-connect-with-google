...
abstract class AbstractOAuthAuthenticator extends OAuth2Authenticator
{
    ...
    {
        return $request->attributes->get('_route') === 'auth_oauth_check' && $request->get('service') === $this->serviceName;
    }
    ...
    abstract function getUserFromResourceOwner(ResourceOwnerInterface $resourceOwner, UserRepository $repository): ?User;
}
